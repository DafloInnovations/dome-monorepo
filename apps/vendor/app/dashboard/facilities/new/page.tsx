...
export default function NewFacilityPage() {
  ...
  return (
    <>
      <Header title="Add Sport" />
      <main className="flex-1 p-6 overflow-auto">
        <button
          type="button"
          onClick={() => router.push("/dashboard/facilities")}
          className="mb-5 inline-flex items-center gap-2 rounded-dome border border-border bg-surface px-4 py-2 text-sm font-semibold text-white transition-colors hover:border-primary hover:text-primary"
        >
          ← Back
        </button>
